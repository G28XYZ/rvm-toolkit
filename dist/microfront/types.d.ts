 ...
 */
export type MicrofrontendMountResult = void | (() => void) | {
    unmount?: () => void;
    dispose?: () => void;
};
/**
 ...
 */
export type MicrofrontendMount<TContext = BaseMicrofrontendContext> = (element: HTMLElement, props: MicrofrontendProps<TContext>) => MicrofrontendMountResult;
/**
